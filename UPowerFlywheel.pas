...
var
  ...
  Z2: string; //тип двигателя
  Z1,         //мощность двигателя
  R,          //длина кривошипа
  L,          //длина шатуна
  BS,         //расстояние до центра тяжести шатуна
  N1,         //обороты кривошипа (частота вращения)
  FR,         //сила резания
  AS1,        //расстояние до центра тяжести кривошипа
  N,          //№ точки начала силы резания
  ...
  i,iK:integer;  //переменная для цикла
...
begin
  ...
  LabelOriginal.Caption:='Введите исходные данные';
...
procedure TPowerFlywheelCreate.Edit1Change(Sender: TObject); //проверка на наличие в полях edit содержимого
begin                                                   //если хоть одно поле пустует, нельзя продолжать
